...
<p align="center">
  <strong>克隆即开工 — 全栈管理系统脚手架</strong><br>
  Clone & Code — Full-stack Management System Scaffold
</p>
...
A full-stack management system scaffold for developers. Ships with RBAC, dual-identity auth, WeChat Pay, file upload, and a one-command CRUD module generator. Clone → configure → code.
